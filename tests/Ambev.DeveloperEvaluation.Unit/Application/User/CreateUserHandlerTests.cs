...
public class CreateUserHandlerTests
{
    ...
    public async Task Handle_ValidRequest_ReturnsSuccessResponse()
    {
        ...
        var user = new DeveloperEvaluation.Domain.Entities.User.User
        {
            Id = Guid.NewGuid(),
        ...
        _mapper.Map<DeveloperEvaluation.Domain.Entities.User.User>(command).Returns(user);
        _mapper.Map<CreateUserResult>(user).Returns(result);

        _userRepository.CreateAsync(Arg.Any<DeveloperEvaluation.Domain.Entities.User.User>(), Arg.Any<CancellationToken>())
            .Returns(user);
        ...
        await _userRepository.Received(1).CreateAsync(Arg.Any<DeveloperEvaluation.Domain.Entities.User.User>(), Arg.Any<CancellationToken>());
    }
    ...
    public async Task Handle_ValidRequest_HashesPassword()
    {
        ...
        await _userRepository.Received(1).CreateAsync(
            Arg.Is<DeveloperEvaluation.Domain.Entities.User.User>(u => u.Password == hashedPassword),
    ...
    public async Task Handle_ValidRequest_MapsCommandToUser()
    {
        ...
        // Then
        _mapper.Received(1).Map<DeveloperEvaluation.Domain.Entities.User.User>(Arg.Is<CreateUserCommand>(c =>
